...
class IosProject implements XcodeBasedProject {
  ...
  String get productBundleIdentifier {
    if (parent.flavor != null) {
      ...
      final String fromPbxproj = _firstMatchInFile(
          xcodeProjectInfoFile, _productBundleIdPattern)?.group(2);
      if (fromPbxproj != null &&
  ...
  Map<String, String> get buildSettings {
    ...
    if (parent.flavor == null)
      ...
      return xcode.xcodeProjectInterpreter.getBuildSettingsForScheme(xcodeProject.path, parent.flavor);
  }
